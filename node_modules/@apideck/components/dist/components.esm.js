import React, { forwardRef, Fragment, useState, useEffect, useCallback, useContext, createContext, useRef, createRef } from 'react';
import classNames from 'classnames';
import { Transition, Menu, Switch } from '@headlessui/react';
import { createPortal } from 'react-dom';
import { useClipboard } from 'use-clipboard-copy';

var Alert = /*#__PURE__*/forwardRef(function Alert(_ref, ref) {
  ...
  var icon = {
    ...
    primary: React.createElement("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      className: iconClassNames,
      viewBox: "0 0 20 20",
      fill: "currentColor"
  ...
  return React.createElement("div", {
  ...
  }, icon[variant]), React.createElement("div", {
  ...
  }, title) : null, description || children ? React.createElement("div", {
  ...
  }, description || children) : null), onClose ? React.createElement("div", {
    ...
    className: "sr-only"
  }, "Dismiss"), React.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    className: "h-6 w-6",
    fill: "none",
    viewBox: "0 0 24 24",
...
var Button = /*#__PURE__*/forwardRef(function Button(_ref, ref) {
  ...
  return React.createElement("button", Object.assign({
    ...
    disabled: disabled,
    ref: ref
  }, other), isLoading && React.createElement("svg", {
...
var Card = /*#__PURE__*/forwardRef(function Card(_ref, ref) {
  ...
  }, other), image ? React.createElement("div", {
    className: "flex-shrink-0"
  ...
  }, description), icons && React.createElement("div", {
  ...
  }), icons.length > 7 && React.createElement("span", {
...
var CheckBox = /*#__PURE__*/forwardRef(function CheckBox(_ref, ref) {
...
var Wrapper = function Wrapper(_ref2) {
  ...
  }, label), labelDescription && React.createElement("p", {
    className: "text-gray-500 dark:text-gray-400"
  }, labelDescription))) : React.createElement(Fragment, null, children);
};
...
var Chip = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  }, hasIcon && React.createElement(React.Fragment, null, iconComponent ? React.createElement("div", {
    className: classNames('inline-flex items-center h-full mr-2', iconStyle),
    "data-testid": "chip-image-component"
  }, iconComponent) : iconUrl && React.createElement("div", {
    className: classNames('inline-flex items-center h-full mr-2', iconStyle),
...
var Modal = /*#__PURE__*/React.forwardRef(function Modal(props, ref) {
  ...
  }, other), hasCloseIcon && React.createElement("button", {
...
var ModalProvider = function ModalProvider(_ref) {
  ...
  var addModal = useCallback(function (content, options) {
  ...
  }, modalContent && React.createElement(Modal, Object.assign({
    isOpen: isOpen,
...
var DateInput = function DateInput(_ref) {
  ...
  var _useState4 = useState(value ? new Date(value).getFullYear() : new Date(minDate != null ? minDate : new Date()).getFullYear()),
      year = _useState4[0],
      setYear = _useState4[1];

  var _useState5 = useState(value ? new Date(value).getMonth() : new Date(minDate != null ? minDate : new Date()).getMonth()),
      month = _useState5[0],
      setMonth = _useState5[1];

  var _useState6 = useState(value ? new Date(value).getDate() : null),
      day = _useState6[0],
      setDay = _useState6[1];
  ...
  })), datePickerValue && onClear && React.createElement("button", {
  ...
  }, monthNames[month]), React.createElement("input", {
  ...
  }), type === 'datetime' && React.createElement(React.Fragment, null, React.createElement("input", {
...
var Dropdown = /*#__PURE__*/forwardRef(function Dropdown(_ref, ref) {
  ...
  var _useState = useState(selectedOption || null),
  ...
  return React.createElement(Menu, Object.assign({
    ...
    return React.createElement(React.Fragment, null, trigger ? React.createElement(Menu.Button, {
    ...
    }, (activeOption == null ? void 0 : activeOption.label) || buttonLabel, React.createElement("svg", {
      ...
      clipRule: "evenodd"
    }))), activeOption && onClear && React.createElement("button", {
    ...
    }), (searchTerm == null ? void 0 : searchTerm.length) > 0 && React.createElement("button", {
    ...
    }, (searchTerm == null ? void 0 : searchTerm.length) > 0 && !(menuOptions != null && menuOptions.length) ? React.createElement("p", {
      ...
      return React.createElement(Menu.Item, {
        ...
        }, (_option$href = option.href) != null && _option$href.length ? React.createElement("a", {
          href: option.href,
          className: labelClassName
        }, option.imageUrl && React.createElement("img", {
          src: option.imageUrl,
...
var Select = /*#__PURE__*/forwardRef(function Select(_ref, ref) {
  var _classNames;
...
var TextInput = /*#__PURE__*/forwardRef(function TextInput(_ref, ref) {
  ...
  if (sensitive || canBeCopied || searchable) {
    ...
    return React.createElement("div", {
    ...
    }, searchable && React.createElement(Fragment, null, React.createElement("div", {
      ...
      clipRule: "evenodd"
    }))), onCloseIconClick && React.createElement("div", {
    ...
    })), canBeCopied && React.createElement("button", {
      onClick: function onClick() {
    ...
    }, clipboard.copied ? React.createElement("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      className: "h-5 w-5",
      viewBox: "0 0 20 20",
      fill: "currentColor"
  ...
  if (prepend || append) {
    ...
    }, prepend), React.createElement(Input, Object.assign({}, props, {
      type: type,
      ref: ref,
    ...
    })), append && React.createElement("span", {
...
var Input = /*#__PURE__*/forwardRef(function TextInput(_ref2, ref) {
  var _classNames, _classNames2;
...
var Toggle = /*#__PURE__*/forwardRef(function Toggle(_ref, ref) {
  ...
  if (label) {
    return React.createElement(Switch.Group, {
      as: "div",
      className: "flex items-center"
    }, React.createElement(ToggleComponent, Object.assign({
      ref: ref
    }, props)), React.createElement(Switch.Label, {
      as: "span",
      className: "ml-3 text-gray-900 dark:text-white " + labelClassName
    }, label));
  }

  return React.createElement(ToggleComponent, Object.assign({}, props));
});
var ToggleComponent = /*#__PURE__*/forwardRef(function Toggle(_ref2, ref) {
  ...
  return React.createElement(Switch, Object.assign({
    checked: isEnabled,
    onChange: onToggle,
    ...
    fill: "currentColor",
    d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"
  })) : null, hasIcons && !isLoading ? React.createElement(Fragment, null, React.createElement("span", {
...
var Tooltip = function Tooltip(_ref) {
  ...
  if (!text) return React.createElement(React.Fragment, null, children);
  var ref = createRef();
...
export { Alert, Button, Card, CheckBox, Chip, DateInput, Dropdown, Modal, ModalProvider, Select, TextArea, TextInput, Toast, ToastProvider, Toggle, Tooltip, useDebounce, useModal, useOutsideClick, usePrevious, useToast };
